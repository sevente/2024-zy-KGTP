...
if __name__ == "__main__":
    save_path = "/home/sdb/xx/path/LLM/SFTData2Text/Dataset/DARTPrompt"
    data_path = "/home/sdb/xx/path/LLM/references/ControlPrefixes/src/data/DART"

    for mode in ["train", "test_both", "val",]:
        if mode in ["test_both", ]:
            for idx in ["", 2, 3]:
