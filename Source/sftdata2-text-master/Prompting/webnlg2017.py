...
if __name__ == "__main__":
    save_path = "/home/sdb/xx/path/LLM/SFTData2Text/Dataset/webnlg17Prompt"
    data_path = "/home/sdb/xx/path/LLM/references/ControlPrefixes/src/data/webnlg17"

    for mode in ["train", "test_both", "val", "test_seen", "test_unseen"]:
        if mode in ["test_seen", "test_unseen", "test_both"]:
            for idx in ["", 2, 3]:
